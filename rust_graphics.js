...
export class RustCanvas {
    ...
    static __wrap(ptr) {
        const obj = Object.create(RustCanvas.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_rustcanvas_free(ptr);
    }
    /**
    * @returns {RustCanvas}
    */
    static new() {
        var ret = wasm.rustcanvas_new();
        return RustCanvas.__wrap(ret);
    }
    /**
    */
    initialize() {
        wasm.rustcanvas_initialize(this.ptr);
    }
    /**
    * @param {number} num_particles
    */
    initialize_particles(num_particles) {
        wasm.rustcanvas_initialize_particles(this.ptr, num_particles);
    }
    /**
    * @param {number} delta
    */
    update_1(delta) {
        wasm.rustcanvas_update_1(this.ptr, delta);
    }
    /**
    * @param {number} delta
    */
    update_2(delta) {
        wasm.rustcanvas_update_2(this.ptr, delta);
    }
    /**
    */
    render() {
        wasm.rustcanvas_render(this.ptr);
    }
    /**
    * @param {number} x
    * @param {number} y
    ...
    * @param {number} vel_y
    */
    spawn_particle(x, y, vel_x, vel_y) {
        wasm.rustcanvas_spawn_particle(this.ptr, x, y, vel_x, vel_y);
    }
    /**
    * @param {number} x
    * @param {number} y
    */
    spawn_gravity_well(x, y) {
        wasm.rustcanvas_spawn_gravity_well(this.ptr, x, y);
    }
    /**
    * @param {number} x
    * @param {number} y
    ...
    */
    try_selecting(x, y) {
        var ret = wasm.rustcanvas_try_selecting(this.ptr, x, y);
        return ret !== 0;
    }
    /**
    */
    release_selection() {
        wasm.rustcanvas_release_selection(this.ptr);
    }
    /**
    * @param {number} new_x
    * @param {number} new_y
    */
    move_selection_to(new_x, new_y) {
        wasm.rustcanvas_move_selection_to(this.ptr, new_x, new_y);
    }
    /**
    * @param {number} x
    * @param {number} y
    */
    try_removing(x, y) {
        wasm.rustcanvas_try_removing(this.ptr, x, y);
    }
    /**
    */
    clear_particles() {
        wasm.rustcanvas_clear_particles(this.ptr);
    }
    /**
    * @param {number} num_to_remove
    */
    remove_particles(num_to_remove) {
        wasm.rustcanvas_remove_particles(this.ptr, num_to_remove);
    }
    /**
    * @param {number} new_mass
    */
    set_gravity_well_mass(new_mass) {
        wasm.rustcanvas_set_gravity_well_mass(this.ptr, new_mass);
    }
    /**
    * @returns {number}
    */
    get_gravity_well_mass() {
        var ret = wasm.rustcanvas_get_gravity_well_mass(this.ptr);
        return ret;
    }
    /**
    * @returns {number}
    */
    get_particle_count() {
        var ret = wasm.rustcanvas_get_particle_count(this.ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} scale
    */
    set_particle_trail_scale(scale) {
        wasm.rustcanvas_set_particle_trail_scale(this.ptr, scale);
    }
    /**
    * @returns {number}
    */
    get_particle_trail_scale() {
        var ret = wasm.rustcanvas_get_particle_trail_scale(this.ptr);
        return ret;
    }
    /**
    * @param {boolean} new_state
    */
    set_borders_active(new_state) {
        wasm.rustcanvas_set_borders_active(this.ptr, new_state);
    }
    /**
    * @param {boolean} new_state
    */
    set_should_clear_screen(new_state) {
        wasm.rustcanvas_set_should_clear_screen(this.ptr, new_state);
    }
    /**
    * @param {string} name
    * @param {HTMLImageElement} image
    */
    add_texture_from_image(name, image) {
        try {
            var ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.rustcanvas_add_texture_from_image(this.ptr, ptr0, len0, addBorrowedObject(image));
        } finally {
